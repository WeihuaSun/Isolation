...
public class ItalianoStack<V extends Vertex,E> {
    public DefaultDirectedGraph<V,E> g;
    private final E[][] parent;
    private final boolean[][] desc;
    private InsertRecord record;
    private final Stack<InsertRecord> stack;
    public ItalianoStack(DefaultDirectedGraph<V,E> g, Class<? extends E> edgeClass){
        this.g = g;
    ...
    public boolean reachable(V s,V t){
        return desc[s.id][t.id];
    }
